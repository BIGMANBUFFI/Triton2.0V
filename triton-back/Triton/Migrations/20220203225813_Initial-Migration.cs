        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_Administrators_AdministratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointsToPass = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ExamsQuestionsAnswers",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ExamQuestionId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamsQuestionsAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamsQuestionsAnswers_ExamsQuestions_ExamQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_AdministratorId",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamsQuestionsAnswers_ExamQuestionId",
                table: "ExamsQuestionsAnswers",
